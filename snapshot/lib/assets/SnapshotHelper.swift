...
#if swift(>=4.0)
// This class uses features available on Xcode9.0+. As we can not check for the
// current Xcode version we are asking for the compiler. This will fails in
// scenarios where the developer add new swift compilers to previous versions
...
#else
// Implementation for Xcode <= 8.3.3
open class Snapshot: NSObject {
